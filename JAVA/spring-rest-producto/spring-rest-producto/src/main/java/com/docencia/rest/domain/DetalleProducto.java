...
public class DetalleProducto {
     ...
     *
     * @param id                       id del detalleProducto
     * @param productoId               id del producto
     * @param descripcionLarga         descripcion larga del producto
     * @param especificacionesTecnicas especificaciones tecnicas del producto
     * @param tags                     tags del producto
     */
    public DetalleProducto(int id, int productoId, String descripcionLarga,
